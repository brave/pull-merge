...
const COUNT_TOKENS_HASHFUN = {
  ...
  'global.anthropic.claude-opus-5-5-v1:0': anthropicCountTokens,
  'global.anthropic.claude-opus-5-v1:0': anthropicCountTokens,
  'global.anthropic.claude-sonnet-5-v1:0': anthropicCountTokens,
